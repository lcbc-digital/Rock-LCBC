...
This can be due to multiple threads updating the same attribute at the same time." );
        ...
        /*
            ...
            and encrypts the value before saving it to the database, there is no need to encrypt
            the value before calling SaveAttributeValue().
        */

        /// <summary>
        /// Saves an attribute value. If the attribute field type is an <see cref="Field.Types.EncryptedTextFieldType"/> the value will be encrypted.
        /// </summary>
        /// <param name="model">The model.</param>
