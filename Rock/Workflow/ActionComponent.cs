...
namespace Rock.Workflow
{
    ...
    public abstract class ActionComponent : Component
    {
        ...
        /*
            ...
            and encrypts the value before setting it on the activity, there is no need to encrypt the
            values before calling SetWorkflowAttributeValue().
        */
        ...
        protected AttributeCache SetWorkflowAttributeValue( WorkflowAction action, Guid guid, string value )
        {
            ...
            if ( attr != null )
            {
                if ( attr.FieldType.Field is Field.Types.EncryptedTextFieldType )
                {
